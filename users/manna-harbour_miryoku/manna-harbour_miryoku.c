...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_miryoku(
    ...
    U_NP,              U_NP,              LT(MEDIA, KC_ESC),   LT(MOUSE, KC_TAB),  LT(NAV, KC_ENT),   LT(SYM, KC_SPC), LT(NUM, KC_BSCP),   LT(FUN, KC_DEL), U_NP,              U_NP
  ...
  [BASE] = LAYOUT_miryoku(
    ...
    LGUI_T(KC_A),      LALT_T(KC_S),      LSFT_T(KC_D),      LCTL_T(KC_F),      KC_G,              KC_H,              RCTL_T(KC_J),      RSFT_T(KC_K),      RALT_T(KC_L),      RGUI_T(KC_QUOT),
    LT(BUTTON, KC_Z),  ALGR_T(KC_X),      KC_C,              KC_V,              KC_B,              KC_N,              KC_M,              KC_COMM,           ALGR_T(KC_DOT),    LT(BUTTON, KC_SLSH),
    U_NP,              U_NP,              LT(MEDIA, KC_ESC), LT(MOUSE, KC_TAB),   LT(NAV, KC_ENT), LT(SYM, KC_SPC),   LT(NUM, KC_BSPC),  LT(FUN, KC_DEL),   U_NP,              U_NP
  #elif defined MIRYOKU_ALPHAS_QWERTZ
    KC_Q,              KC_W,              KC_E,              KC_R,              KC_T,              KC_Z,              KC_U,              KC_I,              KC_O,              KC_P,
    LGUI_T(KC_A),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      LGUI_T(KC_QUOT),
    LT(BUTTON, KC_Y),  ALGR_T(KC_X),      KC_C,              KC_V,              KC_B,              KC_N,              KC_M,              KC_COMM,           ALGR_T(KC_DOT),    LT(BUTTON, KC_SLSH),
  ...
  [NAV] = LAYOUT_miryoku(
    RESET,   U_NA,    U_NA,    U_NA,    U_NA,    U_RDO,   U_PST,   U_CPY,   U_CUT,   U_UND,
    KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, U_NA,    KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_INS,
    U_NA,    KC_ALGR, U_NA,    U_NA,    U_NA,    KC_CAPS,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,
    U_NP,    U_NP,    U_NA,    U_NA,    U_NA,    KC_ENT,  KC_BSPC, KC_DEL,  U_NP,    U_NP
  ),
  [MOUSE] = LAYOUT_miryoku(
    RESET,   U_NA,    U_NA,    U_NA,    U_NA,    U_RDO,   U_PST,   U_CPY,   U_CUT,   U_UND,
  ...
  [NUM] = LAYOUT_miryoku(
    ...
    KC_SCLN, KC_4,    KC_5,    KC_6,    KC_EQL,  U_NA,    KC_RCTL, KC_RSFT, KC_RALT, KC_RGUI,
  ...
  [SYM] = LAYOUT_miryoku(
    ...
    KC_COLN, KC_DLR,  KC_PERC, KC_CIRC, KC_PLUS, U_NA,    KC_RCTL, KC_RSFT, KC_RALT, KC_RGUI,
  ...
  [FUN] = LAYOUT_miryoku(
    ...
    KC_F11,  KC_F4,   KC_F5,   KC_F6,   KC_SLCK, U_NA,    KC_RCTL, KC_RSFT, KC_RALT, KC_RGUI,
  ...
  [BUTTON] = LAYOUT_miryoku(
    ...
    KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, KC_TRNS, KC_TRNS, KC_RCTL, KC_RSFT, KC_RALT, KC_RGUI,
    U_UND,   U_CUT,   U_CPY,   U_PST,   U_RDO,   U_RDO,   U_PST,   U_CPY,   U_CUT,   U_UND,
